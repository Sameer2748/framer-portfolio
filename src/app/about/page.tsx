  ...
  return (
    <div className="min-h-screen flex justify-start items-start">
      <Container className="relative min-h-screen px-8 md:pt-20 md:pb-10">
        ...
        <p className="text-secondary max-w-lg text-sm md:text-base pt-4 pb-4 px-4 ">I love to traveland explore new places. I'm a buig fan of nature and adventure. I'm also big fan of teechnology and innovation.  </p>
        <DraggableCardDemo />
        <p className="text-secondary max-w-lg text-sm md:text-base pt-4 pb-4 px-4 ">
